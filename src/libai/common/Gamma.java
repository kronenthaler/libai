...
public class Gamma {
    ...
    public static int determineMaximumPrecision() {
        ...
        double digits = trunc(Math.log(macheps) / Math.log(10.0D));
     ...
     * Double.POSITIVE_INFINITY is returned for bad values of x or when overflow
     * would occur.
     *
     * <p>
     * The method used is presented in "An Overview of Software Development for
     * Special Functions" by W. J. Cody in
     * <strong>Lecture Notes in Mathematics</strong>, 506, Numerical Analysis
...
//        return Double.MAX_VALUE;
     ...
     *
     * @return Log gamma for specified parameter. The value
     * Double.POSITIVE_INFINITY is returned for y <= 0.0 or when overflow would
     * occur.
     *
     * <p>
     * Minimax polynomial approximations are used over the intervals [-inf,0],
     * [0,.5], [.5,1.5], [1.5,4.0], [4.0,12.0], [12.0,+inf].
     * </p>
     *
     * <p>
     * See Hart et al, "Computer Approximations", Wiley(1968), p. 130F, and also
     * Cody and Hillstrom, "Chebyshev approximations for the natural logarithm
     * of the Gamma function", Mathematics of Computation, 21, April, 1967, P.
     * 198F.
     * </p>
     *
     * <p>
     * The minimax coefficients for y > 12 come from Hart et al. The other
     * coefficients come from unpublished work by W. J. Cody and L. Stoltz at
     * Argonne National Laboratory. This java code is a fairly straightforward
     * translation of the freely available Fortran function ALGAMA by Cody and
     * Stolz.
     * </p>
     */
...
//      res = Double.MAX_VALUE;
    ...
    /**
     * Cumulative probability density function for the incomplete gamma
     * function.
     *
   ...
   *  @pa
     * ram maxIter Maximum number of iterations allowed
     *
     ...
     *
     * <p>
     * Either an infinite series summation or a continued fraction approximation
     * is used, depending upon the argument range. See Bhattacharjee GP (1970)
     * The incomplete gamma integral. Applied Statistics, 19: 285-287 (AS32) .
    ...
    public static double incompleteGamma(double x, double alpha) throws IllegalArgumentException {
        return incompleteGamma(x, alpha, MAXPREC, 1000);
    }
}
