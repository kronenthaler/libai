...
import net.sf.libai.ants.algorithms.*;
 ...
 * @author kronenthaler
 */
public class AntSystemRankPanel extends javax.swing.JPanel {

    /** Creates new form AntSystemPanel */
    public AntSystemRankPanel() {
        initComponents();
    }
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
		try{
			final SP_ASR as = new SP_ASR(0, 4, parameterSet.getSelectedIndex());
	...
	static class SP_ASR extends net.sf.libai.ants.algorithms.AntSystemRank{
		protected SP_ASR(int problemInitialNode, int problemDestinationNode, int parametersSet) throws Exception{
			...
			this.setParam(SP_ASR.initialNode  , problemInitialNode);
			this.setParam(SP_ASR.destinationNode , problemDestinationNode);
			...
			switch(parametersSet){
				case 0:
					this.setParam(SP_ASR.maxNumIterations , 5);
					this.setParam(SP_ASR.pheromonesEvaporationRate, 0.8);
					this.setParam(SP_ASR.alpha, 0.5);
					this.setParam(SP_ASR.beta, 0.5);
					this.setParam(SP_ASR.epsilon, 2);
					Env.setAnts(5);
					break;
				case 1:
					this.setParam(SP_ASR.maxNumIterations , 50);
					this.setParam(SP_ASR.pheromonesEvaporationRate, 0.75);
					this.setParam(SP_ASR.alpha, 0.5);
					this.setParam(SP_ASR.beta, 0.75);
					this.setParam(SP_ASR.epsilon, 5);
					Env.setAnts(5);
					break;
				case 2:
					this.setParam(SP_ASR.maxNumIterations , 100);
					this.setParam(SP_ASR.pheromonesEvaporationRate, 0.70);
					this.setParam(SP_ASR.alpha, 0.5);
					this.setParam(SP_ASR.beta, 0.5);
					this.setParam(SP_ASR.epsilon, 7);
					Env.setAnts(10);
					break;
				case 3:
					this.setParam(SP_ASR.maxNumIterations , 200);
					this.setParam(SP_ASR.pheromonesEvaporationRate, 0.65);
					this.setParam(SP_ASR.alpha, 0.5);
					this.setParam(SP_ASR.beta, 0.5);
					this.setParam(SP_ASR.epsilon, 10);
					Env.setAnts(15);
					break;
			}
			/* set enviroment*/
