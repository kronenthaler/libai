 ...
 * @author kronenthaler
 */
public class AntSystemPanel extends javax.swing.JPanel {

    /** Creates new form AntSystemPanel */
    public AntSystemPanel() {
        initComponents();
    }
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
		try{
			final SP_AS as = new SP_AS(0, 4, parameterSet.getSelectedIndex());
	...
	static class SP_AS extends net.sf.libai.ants.algorithms.AntSystem{
		protected SP_AS(int problemInitialNode, int problemDestinationNode, int parametersSet) throws Exception{
