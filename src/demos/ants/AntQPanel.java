...
public class AntQPanel extends javax.swing.JPanel {
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
		try{
			final SP_ANTQ as = new SP_ANTQ(0, 4, parameterSet.getSelectedIndex());
	...
	static class SP_ANTQ extends net.sf.libai.ants.algorithms.AntQ{
		protected SP_ANTQ(int problemInitialNode, int problemDestinationNode, int parametersSet) throws Exception{
			...
			switch(parametersSet){
				...
				case 1:
					...
					//this.setParam(SP_ANTQ.maxCandidates , Integer.MAX_VALUE);
					this.setParam(SP_ANTQ.maxCandidates , 40);
