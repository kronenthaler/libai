...
/**
 *	Pair class allows to keep two elements of possibly different types in the same
 *	structure and can be used for keep pairs key-value.
 *	@author kronenthaler
 */
public final class Pair<V extends Comparable,K extends Comparable> implements Comparable<Pair>{
	...
	/**
	 * Compare two pairs by the first element. The first element type must implement
	 * the Comparable interface.
	 * @param o The pair to compare with.
	 * @return -1 if this is less than o, 0 if are equals, 1 if this is greater than o.
	 */
